...
import static cn.trinea.android.demo.R.id;
...
public class ImagePagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager = (AutoScrollViewPager)v.findViewById(id.view_pager);
        indicator = (CirclePageIndicator)v.findViewById(id.indicator);
